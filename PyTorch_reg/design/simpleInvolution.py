...
class simpleInvolution(nn.Module):
    def __init__(self, input_dim, output_dim):
        super(simpleInvolution, self).__init__()
    ...
    def basic_simple_net(self, input_dim):
        self.basic_block = nn.Sequential(
            ...
            involution(channels=128, kernel_size=3, stride=1),
            nn.BatchNorm2d(128, eps=1e-05, momentum=0.05, affine=True),
            nn.ReLU(inplace=True),
            ...
            involution(channels=256, kernel_size=3, stride=1),
            nn.BatchNorm2d(256, eps=1e-05, momentum=0.05, affine=True),
            nn.ReLU(inplace=True),
